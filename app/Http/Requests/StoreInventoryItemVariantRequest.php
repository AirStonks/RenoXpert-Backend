...
class StoreInventoryItemVariantRequest extends FormRequest
{
    /**
    ...
    public function authorize(): bool
    {
        ...
        // Example: return $this->user()->can('create', InventoryItemVariant::class);
    ...
    public function rules(): array
    {
        return [
            ...
            'sku' => 'nullable|string|max:255|regex:/^[A-Z0-9-]+$/',
            'full_sku' => 'nullable|string|max:255|unique:inventory_item_variants,sku',

...
class RenoXSaleResourceHead extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'status' => $this->status,
            'sales' => SaleResourceHead::collection($this->sales),
            'purchase_orders' => PurchaseOrderResourceHead::collection($this->purchaseOrders),

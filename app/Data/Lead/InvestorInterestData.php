...
use App\Models\Lead\InvestorInterest;
use Illuminate\Validation\Rule;

class InvestorInterestData extends Data
{
    ...
    public static function rules(): array
    {
        return [
            ...
            'email' => ['required', 'email', 'max:255', Rule::unique(\App\Models\Lead\InvestorInterest::class)],

...
namespace App\Data\Foundation; // <-- CORRECTED
...
// --- THESE WERE MISSING ---
use App\Enums\Foundation\UserType;
use App\Enums\Foundation\UserStatus;
// -------------------------
    ...
    public static function rules(): array
    {
        ...
        return [
            ...
            'email' => [
                'required',
                'email',
                Rule::unique(\App\Models\Foundation\User::class, 'email')->ignore($userId)
            ],
            'password' => [
                'nullable',
                'required_if:id,null',

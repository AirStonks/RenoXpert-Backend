...
class OrderQuotation extends Model
{
    ...
    {
        return $this->belongsTo(\App\Models\Business\Order::class, 'order_id', 'id');
    }
    ...
    {
        return $this->belongsTo(\App\Models\Business\Quotation::class, 'quotation_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Business\QuotationPackage::class, 'order_quotation_id');
    }
}

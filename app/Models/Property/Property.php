...
class Property extends Model
{
    ...
    {
        return $this->hasOne(\App\Models\Property\Property\PropertyRoi::class, 'property_id', 'id');
    }
    ...
    {
        return $this->hasMany(\App\Models\Operations\ProjectStatusHistory::class, 'property_id', 'id');
    }
